...
def discover_udp(
    ...
    Sends Vidaa-specific discovery packets to the broadcast address
...
def probe_ip(
    ...
    """Probe a specific IP address for a Vidaa TV.
    ...
    try:
        ...
        _LOGGER.info("Found Vidaa TV at %s: %s (vidaa_support=%s)", ip, name, vidaa_support)
        return device
